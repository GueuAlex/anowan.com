    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 5),
          AppText.small(
            '3- Chaque type de ticket est unique et ne peut être scanné qu\'une seule fois sauf cas spéciaux.  Il est donc fortement recommandé de ne pas partager votre ticket avec d\'autres personnes.',
            fontSize: 13,
          ),
          SizedBox(height: 5),
          if (_showMore)
            Column(
              ...
              children: [
                ...
                SizedBox(height: 5),
                AppText.small(
                  '5- En cas de perte ou de vol, votre ticket ne pourra pas être remplacé.',
                  fontSize: 13,
                ),
                SizedBox(height: 5),
                AppText.small(
